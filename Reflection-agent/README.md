The inspiration for the Reflection mechanism comes from the human learning process: we proofread after completing a first draft and verify after solving a math problem. This idea is embodied in multiple studies, such as the Reflexion framework. Its core workflow can be summarized as a concise three-step loop: Execute -> Reflect -> Refine.
